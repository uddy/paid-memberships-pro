...
function pmpro_is_ready()
{
	...
	else
	{
		...
		{
			if(pmpro_getOption("gateway_environment") && pmpro_getOption("Interswitchcheckout_product_id") && pmpro_getOption("Interswitchcheckout_pay_item_id")&& pmpro_getOption("Interswitchcheckout_mac_key"))
				$pmpro_gateway_ready = true;
			else
				$pmpro_gateway_ready = false;
		}
