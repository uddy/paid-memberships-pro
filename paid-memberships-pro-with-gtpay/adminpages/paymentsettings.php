<?php
	...
	{                   
		...
		//for gtpay WebPAY
		pmpro_setOption("gtpay_interswitch_merchantid");
		...
		<tbody>                		   
			<tr>
				...
				<td>
					<select id="gateway" name="gateway" onchange="pmpro_changeGateway(jQuery(this).val());">
						...
						<option value="gtpay" <?php selected( $gateway, "gtpay" ); ?>>GTPay</option>
					</select>                        
				</td>
			</tr>
		   ...
		   <tr class="gateway gateway_paypal gateway_paypalexpress gateway_paypalstandard" <?php if($gateway != "paypal" && $gateway != "paypalexpress" && $gateway != "paypalstandard") { ?>style="display: none;"<?php } ?>>
			...
			<tr class="gateway gateway_cybersource" <?php if($gateway != "cybersource") { ?>style="display: none;"<?php } ?>>
				...
				<th scope="row" valign="top">
					<label for="gtpay_interswitch_merchantid"><?php _e('Interswitch MerchantID', 'pmpro');?>:</label>
				</th>
				<td>
					<input type="text" id="gtpay_interswitch_merchantid" name="gtpay_interswitch_merchantid" size="60" value="<?php echo esc_attr($gtpay_interswitch_merchantid)?>" />
				</td>
			</tr>
			<tr class="gateway gateway_gtpay" <?php if($gateway != "gtpay") { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">
					<label for="gtpay_merchantid"><?php _e('GTpay MerchantID', 'pmpro');?>:</label>
				</th>
				<td>
					<input type="text" id="gtpay_merchantid" name="gtpay_merchantid" size="60" value="<?php echo esc_attr($gtpay_merchantid)?>" />
				</td>
			</tr>
			<tr class="gateway gateway_gtpay" <?php if($gateway != "gtpay") { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">
					<label for="gtpay_post_url"><?php _e('Gateway Post Url', 'pmpro');?>:</label>
				</th>
				<td>
			...
			<tr class="gateway gateway_gtpay" <?php if($gateway != "gtpay") { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">
					<label for="gtpay_return_url"><?php _e('Gateway Return Url', 'pmpro');?>:</label>
				</th>
				<td>
			...
			<tr class="gateway gateway_ gateway_paypal gateway_paypalexpress gateway_paypalstandard gateway_braintree gateway_twocheckout gateway_cybersource gateway_stripe gateway_authorizenet gateway_payflowpro gateway_check gateway_gtpay" <?php if(!empty($gateway) && $gateway != "paypal" && $gateway != "paypalexpress" && $gateway != "paypalstandard" && $gateway != "braintree" && $gateway != "twocheckout" && $gateway != "cybersource" && $gateway != "payflowpro" && $gateway != "stripe" && $gateway != "gtpay" && $gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">
